...
MAJOR_ARCANA: tuple[TarotCard, ...] = (
    TarotCard(0, "fool", "Шут", "начало пути", "свобода, доверие, свежий взгляд", "хаос, наивность, поспешность", "путник у края", "assets/cards/card_fool.webp"),
    TarotCard(1, "magician", "Маг", "воля и мастерство", "инициатива, фокус, действие", "манипуляция, суета, рассеянность", "жезл и стол мастера", "assets/cards/card_magician.webp"),
    TarotCard(2, "high_priestess", "Жрица", "тайное знание", "интуиция, тишина, глубина", "закрытость, сомнение, пассивность", "лунная завеса", "assets/cards/card_priestess.webp"),
    TarotCard(3, "empress", "Императрица", "рост и плодородие", "забота, изобилие, творчество", "излишества, зависимость от комфорта", "сад и корона", "assets/cards/card_empress.webp"),
    TarotCard(4, "emperor", "Император", "порядок и опора", "границы, структура, ответственность", "жесткость, контроль, упрямство", "трон и камень", "assets/cards/card_emperor.webp"),
